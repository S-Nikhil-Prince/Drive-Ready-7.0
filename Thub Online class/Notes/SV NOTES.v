...
Notes:
System Clock is Always Faster than Serial Clock (Speed is Directly Proportional to the Frequency)
Frequency of the System Clock is greater than the Frequency of the Serial Clock
Q. Why CS' or SS' is Used ?

Ans: SPI Supports the Multidrop Communication (Single Master and Multiple Slaves), If Master wanted connect with any of the slave (or) Slaves then Master will use the CS' or SS' to Select the Particular Slave/ Slaves.

***Note: If master Sends the Data at Posedge clock then Slave Samples the Data at Negedge of Clock. *** (Vice Versa)
...
CPOL CPHA Mode sclk Posedge/ Negedge
0 0 mode 0 0 1st Posedge
